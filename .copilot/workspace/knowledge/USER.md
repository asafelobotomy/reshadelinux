...
|---|---|
|Communication style|Balanced — neither terse nor exhaustive|
|Domain expertise|Intermediate|
|Preferred review depth|Quality-first|
|Working pace / batch size preference|*(to be discovered)*|
|Tolerance for uncertainty|Best judgement — trusts the agent to decide|
|Preferred output format|Balanced level of detail|
|Known strong opinions|Tests should be written alongside code; proactive refactoring is acceptable|
