...
- **Language / runtime**: Bash/Shell / bash 5.3
- **Core value delivered**: Install and manage ReShade shaders for Steam/Proton games on Linux with TUI and GUI interfaces
- **Value stream**: Shell scripts run by user → Wine/Proton game prefixes updated with ReShade DLLs and shaders → enhanced visuals at game runtime
